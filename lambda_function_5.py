...
def content_process(datalist):
    ...
    for i in range(len(datalist)):
        ...
        if datalist[i] == '\n':    
            ...
            front_symbol = datalist[fomer_row_ind+1:i]
            ...
            if flag :
                    ...
                    if len(symbol_nums) == 0:
                        ...
                        if former_is_symbol:
                            if former_flag_3:
                                ...
                                indent_cnt += 1
                            #LOGGER.info(f"symbol:{back_symbol,indent_cnt}")
                        else:
                            if flag_3 == 2:
                                indent_cnt = former_indent - 1
                                former_flag_3 = True
                                former_flag_3_cnt = 0
                                #LOGGER.info(f"symbol:{back_symbol,indent_cnt,former_indent}")
                            elif flag_3 == 1: 
                                indent_cnt = 0
                            else:
                                indent_cnt = former_indent
                ...
                LOGGER.info(f"former_indent:{back_symbol}")
